function [ x,F_error,iter_count ] = Block_JACOBI( A,b,x0,tol,n_iter,n_b )
%Solve "A x = b" for x using block Jacobi iterative method
%Inputs
...
title(['Block Jacobi convergence for matrix A (' num2str(n) ' x ' num2str(n) ')']);
end
